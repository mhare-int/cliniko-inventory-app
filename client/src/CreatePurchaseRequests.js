                        ...
                        minWidth: 90 
                          ...
                          <div style={{ display: "flex", gap: 4, marginTop: 6, justifyContent: "center" }}>
                            <button
                              ...
                              title="Add Item"
                              style={{ background: "#eafbe7", border: "1px solid #14B800", borderRadius: 4, padding: "2px 7px", cursor: addRow.product && addRow.noToOrder > 0 ? "pointer" : "not-allowed", display: "flex", alignItems: "center" }}
                            ><TickIcon /></button>
                            <button
                              type="button"
                              onClick={() => { setAddingRow(false); setAddRow({ product: null, noToOrder: "" }); }}
                              title="Cancel"
                              style={{ background: "#fff0f0", border: "1px solid #FF4D4F", borderRadius: 4, padding: "2px 7px", cursor: "pointer", display: "flex", alignItems: "center" }}
                            ><CrossIcon /></button>
                          </div>
                      </td>
                      <td style={{ 
