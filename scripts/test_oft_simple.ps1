try {
    ...
    $testMessage = "<html><body><h2>Purchase Order Request</h2><p>Dear Supplier,</p><p>Please find our purchase order details below.</p><p>Best regards,<br>Your Company</p></body></html>"
